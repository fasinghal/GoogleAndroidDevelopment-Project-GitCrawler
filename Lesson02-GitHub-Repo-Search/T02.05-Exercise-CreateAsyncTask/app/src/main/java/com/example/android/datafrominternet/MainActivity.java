...
public class MainActivity extends AppCompatActivity {
    ...
    private void makeGithubSearchQuery() {
        ...
        githubSearchResults = githubQueryTask.doInBackground(githubSearchUrl);
        githubQueryTask.onPostExecute(githubSearchResults);*/
    ...
    public class GithubQueryTask extends AsyncTask<URL, Void, String>{
        ...
        protected String doInBackground(URL... urls)  {
            ...
            try{
                gitHubResults= NetworkUtils.getResponseFromHttpUrl(urls[0]);
            }catch (IOException e){
                e.printStackTrace();
            }
